...
def save_info(args, outdir):    
    ...
    with open(info_file, 'w') as f:
        ...
        f.write(f"corrected: {args.corrected}\n")
...
def generate_metrics_and_plots(true_labels, pred_labels, dataset_name, results_dir, model_name):
    ...
    sns.heatmap(cm_normalized, annot=True, fmt='.3f', cmap='Blues', xticklabels=classes, yticklabels=classes, ax=ax)
...
def main(args):
    ...
    if args.hyperset:
        with open('/home/bruno/repos/tesis/Pointnet_Pointnet2_pytorch/data/experimentos/hypersets_paper.json', 'r') as f:  
